...
#include "TrumpetToy.h"
#include "EggDC.h"
#include "CocoonDC.h"
#include "DrumDC.h"
#include "DrumStickDC.h"

#include "CocoonHD.h"
#include "PokemonEgg.h"
#include "d3d8types.h"

#include "UnusedFloat.h"
...
extern "C"
{
	...
	FunctionPointer(int, sub_734AF0, (ObjectMaster *a1, int a2, NJS_CNK_OBJECT *model, NJS_TEXLIST *texlist), 0x734AF0);

	FunctionPointer(void, Chao_Drums, (ObjectMaster *a1), 0x00761330);
	...
	FunctionPointer(char, Chao_SetEmotionBall, (ObjectMaster *a1, int a2, int a3), 0x00736E90);
	...
	void PatchShinyJewelGC()
	{
		...
		WriteData((char*)0x0088A3E8, (char)255);
		WriteData((char*)0x0088A3E9, (char)255);
		WriteData((char*)0x0088A3EA, (char)127);
	...
	FunctionPointer(void, Chao_Trumpet, (ObjectMaster *a1), 0x00761830);
													...
													if ((unsigned __int8)chaotype >= ChaoType_Hero_Normal)
													{
														if (!(((unsigned __int8)chaotype - 6) % 3))
														{
															...
															v36 = (ChaoDataBase *)(unsigned __int16)(unsigned __int64)(acos(-njInnerProduct(
																...
																* 65536.0
																* 0.1591549762031479);
															//njSetTextureNum(dword_34BBCF8[(signed int)(unsigned __int64)((double)(signed int)v36 * 0.0054931640625 + 0.5) % 181] + 6);
															//njRotate(0,((NJS_VECTOR *)&v2->gap6FC[36]);
	...
	FunctionPointer(int, Chao_PlayAnimation2_, (ObjectMaster *a1, int a2, unsigned __int16 a3), 0x00734F20);
	FunctionPointer(int, Chao_Animation, (ObjectMaster *a1, int a2), 0x00734F00);
	FunctionPointer(bool, Chao_Drum, (ObjectMaster *a1), 0x00761960);
	...
	void CaptureChaoMain(ObjectMaster *a1)
	{
		...
		//Chao_Drums(a1);
		sub_737610(a1);
		sub_734AF0(a1, 17, &object_00F005A0, &AL_TOY_TEXLIST);
		//Chao_Drum(a1);
		ChaoData1* data1 = (ChaoData1*)a1->Data1;
		ChaoData2* data2 = (ChaoData2*)a1->Data2;
		//data1->field_B0 |= 0x2000u;
		data1->field_4C[8] = -49;
		//Chao_PlayAnimation2_(a1, 47, 15u);
	}
	...
	{
		Chao_SetEmotionBall(a1, 3, a3);
	}




	void EggDraw(NJS_CNK_OBJECT *a1)
	{
		njSetTexture(&CHAO_TEXLIST);

		//		sub_408530(&object_00147E38);
		sub_408530(&object_0001CA40);
	}
	...
	/*
	void DreamcastCocoon(NJS_CNK_OBJECT *a1)
	{
		sub_408530(&object_0014ABEC);
	}
	*/
	...
	{
		if (a1 == &Trumpet) { njSetTexture(&CHAO_TEXLIST); sub_408530(&object_0014E8E8); }
	...
	__declspec(dllexport) void Init(const char *path)
	{
		...
		*/
		...
		WriteData((char*)0x00437561, (char)3);
		//Shiny Jewels are now transparent
		if (config->getBool("Chao World Extended", "ShinyJewelPC", true))
			PatchShinyJewelPC();
		if (config->getBool("Chao World Extended", "ShinyJewelGC", true))
			PatchShinyJewelGC();
		//Chaos Chao patch
		...
		if (config->getBool("Chao World Extended", "Dreamcast", true))
		{
			...
			WriteCall((void*)0x0078AF58, EggDraw); //not done yet, gonna need to completely rewrite the draw code
			//doesnt work yet, this is gonna be the animal ability swaps - WriteData((int*)0x036BB900, 0x00761830);
